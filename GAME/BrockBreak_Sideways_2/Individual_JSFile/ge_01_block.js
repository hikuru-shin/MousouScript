...
brickChange[++brickChangeNum] = { r:13 , cMin:32 , cMax:45 };
brickChange[++brickChangeNum] = { r:14 , cMin:20 , cMax:24 };
brickChange[++brickChangeNum] = { r:14 , cMin:26 , cMax:31 };
brickChange[++brickChangeNum] = { r:14 , cMin:31 , cMax:45 };
brickChange[++brickChangeNum] = { r:15 , cMin:20 , cMax:30 };
brickChange[++brickChangeNum] = { r:15 , cMin:31 , cMax:41 };
brickChange[++brickChangeNum] = { r:16 , cMin:21 , cMax:26 };
brickChange[++brickChangeNum] = { r:16 , cMin:31 , cMax:39 };
brickChange[++brickChangeNum] = { r:17 , cMin:21 , cMax:24 };
brickChange[++brickChangeNum] = { r:17 , cMin:28 , cMax:33 };
brickChange[++brickChangeNum] = { r:17 , cMin:34 , cMax:38 };
brickChange[++brickChangeNum] = { r:18 , cMin:20 , cMax:25 };
brickChange[++brickChangeNum] = { r:18 , cMin:27 , cMax:34 };
brickChange[++brickChangeNum] = { r:18 , cMin:35 , cMax:39 };
brickChange[++brickChangeNum] = { r:19 , cMin:19 , cMax:26 };
brickChange[++brickChangeNum] = { r:19 , cMin:27 , cMax:39 };
brickChange[++brickChangeNum] = { r:19 , cMin:40 , cMax:42 };
brickChange[++brickChangeNum] = { r:20 , cMin:20 , cMax:26 };
brickChange[++brickChangeNum] = { r:20 , cMin:29 , cMax:39 };
brickChange[++brickChangeNum] = { r:20 , cMin:40 , cMax:43 };
brickChange[++brickChangeNum] = { r:21 , cMin:19 , cMax:24 };
brickChange[++brickChangeNum] = { r:21 , cMin:31 , cMax:38 };
brickChange[++brickChangeNum] = { r:21 , cMin:40 , cMax:43 };
...
brickChange[++brickChangeNum] = { r:23 , cMin:19 , cMax:25 };
brickChange[++brickChangeNum] = { r:23 , cMin:26 , cMax:30 };
brickChange[++brickChangeNum] = { r:23 , cMin:30 , cMax:33 };
brickChange[++brickChangeNum] = { r:24 , cMin:20 , cMax:26 };
brickChange[++brickChangeNum] = { r:24 , cMin:27 , cMax:30 };
brickChange[++brickChangeNum] = { r:25 , cMin:19 , cMax:28 };
brickChange[++brickChangeNum] = { r:26 , cMin:18 , cMax:28 };
brickChange[++brickChangeNum] = { r:27 , cMin:17 , cMax:29 };
brickChange[++brickChangeNum] = { r:28 , cMin:17 , cMax:30 };
brickChange[++brickChangeNum] = { r:29 , cMin:18 , cMax:28 };
